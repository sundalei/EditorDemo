...
import org.gwtproject.tutorial.client.ContactFactory;
import org.gwtproject.tutorial.client.ContactFactory.PhoneRequest;
import org.gwtproject.tutorial.client.PhoneProxy;
import org.gwtproject.tutorial.client.event.EditPhoneEvent;
...
public class PhoneEditor extends Composite implements ValueAwareEditor<PhoneProxy> {
	...
	private static PhoneEditorUiBinder uiBinder = GWT.create(PhoneEditorUiBinder.class);
	...
	/*
	 * called if the backend supports in-place property updates, otherwise updates
	 * will be passed via setValue.
	 * 
	 * @see
	 * com.google.gwt.editor.client.ValueAwareEditor#onPropertyChange(java.lang.
	 * String[])
	 */
	...
	public void setDelegate(EditorDelegate<PhoneProxy> delegate) {
		...
		subscription = this.addEditPhoneHandler(new EditPhoneEvent.Handler() {
			...
			@Override
			public void startEdit(PhoneProxy phone, RequestContext requestContext) {
	...
	/*
	 * called if the backend doesn't support in-place property updates, otherwise
	 * updates will be passed via setValue
	 * 
	...
	private void onEditPhoneEvent(PhoneProxy phone, RequestContext requestContext) {
